...
const plans = [
  {
    ...
    features: [
      ...
      { name: "3 video analyses per month", included: true },
      { name: "Keyword suggestions", included: true },
      { name: "Community support", included: true },
      { name: "AI thumbnail generator", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Unlimited video analyses", included: true },
      { name: "AI thumbnail generator", included: true },
      { name: "Competitor tracking (5 channels)", included: true },
